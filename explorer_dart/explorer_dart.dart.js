...
$$.initFileSystem_anon = {"":
 ...
 call$1: function(grantedBytes) {
  $.window().webkitRequestFileSystem$4(1, grantedBytes, new $.initFileSystem_anon1(), new $.initFileSystem_anon2());
}
};

$$.initFileSystem_anon1 = {"":
 [],
 "super": "Closure",
 call$1: function(filesystem) {
  $.fs = filesystem;
  $.actualDirectory = $.fs.get$root();
  $.window().get$console().log$1($.fs);
  $.loadFileSystem();
}
};

$$.initFileSystem_anon2 = {"":
 [],
 "super": "Closure",
 call$1: function(e) {
  return;
...
$$.onChange_anon = {"":
 ...
 call$1: function(entry) {
  entry.copyTo$4($.actualDirectory, entry.get$name(), new $.onChange_anon0(), new $.onChange_anon1());
}
};
...
$$.updateExplorer_anon = {"":
 [],
 "super": "Closure",
 call$1: function(dirs) {
  $.addNodeExplorer(dirs);
}
};

$$.updateExplorer_anon0 = {"":
 [],
 "super": "Closure",
 call$1: function(e) {
  return;
...
$$.onDrop_anon = {"":
 [],
 "super": "Closure",
 call$1: function(copiedEntry) {
  $.window().get$console().log$1('Directory Entry ' + $.S(copiedEntry.get$name()) + ' load Success!!');
  $.updateExplorer();
}
};
...
$$.onDrop_anon1 = {"":
 ...
 "super": "Closure",
 call$1: function(copiedEntry) {
  $.window().get$console().log$1('File Entry ' + $.S(copiedEntry.get$name()) + ' load Success!!');
  $.updateExplorer();
}
};
...
$.onDrop = function(e) {
  e.stopPropagation$0();
  e.preventDefault$0();
  $.window().get$console().log$1(e);
  var length$ = $.get$length(e.get$dataTransfer().get$items());
  if (typeof length$ !== 'number')
    return $.onDrop$bailout(1, e, length$);
  var entries = $.ListImplementation_List(null);
  for (var i = 0; i < length$; ++i) {
    var entry = e.get$dataTransfer().get$items().item$1(i).webkitGetAsEntry$0();
    entries.push(entry);
    if (entry.get$isDirectory() === true)
      entry.copyTo$4($.actualDirectory, entry.get$name(), new $.onDrop_anon(), new $.onDrop_anon0());
    else
      entry.copyTo$4($.actualDirectory, entry.get$name(), new $.onDrop_anon1(), new $.onDrop_anon2());
  }
};
...
$.addNodeExplorer = function(entries) {
  if (typeof entries !== 'string' && (typeof entries !== 'object' || entries === null || entries.constructor !== Array && !entries.is$JavaScriptIndexingBehavior()))
    return $.addNodeExplorer$bailout(1, entries);
  $.window().get$console().log$1(entries);
  $.deleteContentExplorer();
  var fragment = $.document().createDocumentFragment$0();
  var ul = $.Element_Element$tag('ul');
  $.add$1(fragment.get$elements(), ul);
  var length$ = entries.length;
  for (var i = 0; i < length$; ++i) {
    if (i < 0 || i >= entries.length)
      throw $.ioore(i);
    var entry = entries[i];
    var dataPath = $.replaceAll(entry.get$fullPath(), '//', '///');
    var li = $.LIElement_LIElement();
    $.indexSet(li.get$attributes(), 'id', dataPath);
    $.indexSet(li.get$attributes(), 'data-path', dataPath);
    var img = $.Element_Element$tag('img');
    $.add$1(img.get$classes(), 'folder');
    var div = $.Element_Element$tag('div');
    $.indexSet(div.get$attributes(), 'data-filename', '');
    div.set$innerHTML(entry.get$name());
    $.add$1(li.get$nodes(), img);
    $.add$1(li.get$nodes(), div);
    $.add$1($.AnchorElement_AnchorElement($).get$classes(), 'folfer');
    if (entry.get$isFile() === true) {
      img.set$src('img/mimetypes/text-plain.png');
      img.set$width(32);
    } else {
      img.set$src('img/folder.png');
      img.set$width(32);
    }
    $.add$1(ul.get$nodes(), li);
  }
  $.add$1($.document().query$1('[id="explorer-nav"]').get$nodes(), fragment);
};

$.onChange = function(e) {
  $.forEach(e.get$target().get$webkitEntries(), new $.onChange_anon());
};
...
$.main = function() {
  $.window().get$console().log$1('main');
  var dropbox = $.window().get$document().query$1('[id=\'explorer\']');
  dropbox.get$on().get$dragEnter().add$2($.onDragEnter, false);
  dropbox.get$on().get$dragOver().add$2($.onDragOver, false);
  dropbox.get$on().get$drop().add$2($.onDrop, false);
  dropbox.get$on().get$dragEnd().add$2($.onDragEnd, false);
  $.window().get$document().query$1('#file_input').get$on().get$change().add$2($.onChange, false);
  $.initFileSystem();
};
...
$.initFileSystem = function() {
  $.window().get$webkitStorageInfo().requestQuota$4(1, 5242880, new $.initFileSystem_anon(), new $.initFileSystem_anon0());
};
...
$.loadFileSystem = function() {
  $.actualDirectory.createReader$0().readEntries$2(new $.loadFileSystem_anon(), new $.loadFileSystem_anon0());
};
...
$._convertNativeToDart_Dictionary = function(object) {
  if (object == null)
    return;
  var dict = $.makeLiteralMap([]);
  if (typeof dict !== 'object' || dict === null || (dict.constructor !== Array || !!dict.immutable$list) && !dict.is$JavaScriptIndexingBehavior())
    return $._convertNativeToDart_Dictionary$bailout(1, object, dict);
  for (var t1 = $.iterator(Object.getOwnPropertyNames(object)); t1.hasNext$0() === true;) {
    var t2 = t1.next$0();
    var t3 = object[t2];
    if (t2 !== (t2 | 0))
      throw $.iae(t2);
    if (t2 < 0 || t2 >= dict.length)
      throw $.ioore(t2);
    dict[t2] = t3;
  }
  return dict;
...
$.updateExplorer = function() {
  $.actualDirectory.createReader$0().readEntries$2(new $.updateExplorer_anon(), new $.updateExplorer_anon0());
};
...
$.deleteContentExplorer = function() {
  var childs = $.document().query$1('[id="explorer-nav"]').get$nodes();
  if ($.gtB($.get$length(childs), 0))
    $.clear(childs);
};
...
$.onDrop$bailout = function(state, e, length$) {
  var entries = $.ListImplementation_List(null);
  for (var i = 0; $.ltB(i, length$); ++i) {
    var entry = e.get$dataTransfer().get$items().item$1(i).webkitGetAsEntry$0();
    entries.push(entry);
...
$.addNodeExplorer$bailout = function(state, entries) {
  $.window().get$console().log$1(entries);
  $.deleteContentExplorer();
  var fragment = $.document().createDocumentFragment$0();
  var ul = $.Element_Element$tag('ul');
  $.add$1(fragment.get$elements(), ul);
  var length$ = $.get$length(entries);
  for (var i = 0; $.ltB(i, length$); ++i) {
...
$._convertNativeToDart_Dictionary$bailout = function(state, object, dict) {
  for (var t1 = $.iterator(Object.getOwnPropertyNames(object)); t1.hasNext$0() === true;) {
    var t2 = t1.next$0();
    $.indexSet(dict, t2, object[t2]);
  }
  return dict;
};
...
$.onDragOver.call$1 = $.onDragOver;
$.onDragOver.$name = "onDragOver";
$.onDragEnter.call$1 = $.onDragEnter;
$.onDragEnter.$name = "onDragEnter";
$.typeNameInIE.call$1 = $.typeNameInIE;
$.typeNameInIE.$name = "typeNameInIE";
$.onDrop.call$1 = $.onDrop;
$.onDrop.$name = "onDrop";
$.onDragEnd.call$1 = $.onDragEnd;
$.onDragEnd.$name = "onDragEnd";
$.typeNameInFirefox.call$1 = $.typeNameInFirefox;
$.typeNameInFirefox.$name = "typeNameInFirefox";
$.constructorNameFallback.call$1 = $.constructorNameFallback;
$.constructorNameFallback.$name = "constructorNameFallback";
$.onChange.call$1 = $.onChange;
...
$.CTC19 = new Isolate.$isolateProperties.NotImplementedException('structured clone of ArrayBufferView');
$.CTC5 = new Isolate.$isolateProperties._DeletedKeySentinel();
$.CTC24 = 'frozen class set cannot be modified';
$.CTC6 = new Isolate.$isolateProperties.UnsupportedOperationException('frozen class set cannot be modified');
$.CTC25 = 'structured clone of FileList';
$.CTC17 = new Isolate.$isolateProperties.NotImplementedException('structured clone of FileList');
$.CTC26 = 'structured clone of other type';
$.CTC20 = new Isolate.$isolateProperties.NotImplementedException('structured clone of other type');
...
$.CTC30 = 'Invalid list length';
$.CTC14 = new Isolate.$isolateProperties.IllegalArgumentException('Invalid list length');
$.CTC31 = 'structured clone of RegExp';
$.CTC8 = new Isolate.$isolateProperties.NotImplementedException('structured clone of RegExp');
$.CTC32 = 'structured clone of File';
$.CTC15 = new Isolate.$isolateProperties.NotImplementedException('structured clone of File');
...
$.CTC2 = new Isolate.$isolateProperties.UnsupportedOperationException('Cannot removeLast on immutable List.');
$.CTC35 = 'structured clone of Date';
$.CTC7 = new Isolate.$isolateProperties.NotImplementedException('structured clone of Date');
$.CTC36 = 'structured clone of ArrayBuffer';
$.CTC18 = new Isolate.$isolateProperties.NotImplementedException('structured clone of ArrayBuffer');
$.CTC12 = new Isolate.$isolateProperties.IllegalAccessException();
$.CTC37 = 'structured clone of Blob';
$.CTC16 = new Isolate.$isolateProperties.NotImplementedException('structured clone of Blob');
$.CTC38 = null;
...
$.$defineNativeClass('HTMLAnchorElement', ["href!", "name?", "target?"], {
 toString$0: function() {
...
$.$defineNativeClass('HTMLAppletElement', ["name?", "width!"], {
 is$Element: function() { return true; }
});
...
$.$defineNativeClass('HTMLCanvasElement', ["width!"], {
 is$Element: function() { return true; }
});
...
$.$defineNativeClass('HTMLEmbedElement', ["name?", "src!", "width!"], {
 is$Element: function() { return true; }
});
...
$.$defineNativeClass('Entry', ["fullPath?", "isDirectory?", "isFile?", "name?"], {
...
$.$defineNativeClass('EntrySync', ["fullPath?", "isDirectory?", "isFile?", "name?"], {
 remove$0: function() {
  return this.remove();
}
});
...
$.$defineNativeClass('HTMLIFrameElement', ["name?", "src!", "width!"], {
 is$Element: function() { return true; }
});
...
$.$defineNativeClass('HTMLImageElement', ["name?", "src!", "width!"], {
 is$Element: function() { return true; }
});

$.$defineNativeClass('HTMLInputElement', ["name?", "src!", "value=", "webkitEntries?", "width!"], {
 get$on: function() {
...
$.$defineNativeClass('HTMLLinkElement', ["href!", "target?"], {
 is$Element: function() { return true; }
});
...
$.$defineNativeClass('HTMLMarqueeElement', ["width!"], {
 is$Element: function() { return true; }
});
...
$.$defineNativeClass('HTMLObjectElement', ["name?", "width!"], {
 is$Element: function() { return true; }
});
...
$.$defineNativeClass('SQLResultSetRowList', ["length?"], {
 item$1: function(index) {
  return $._convertNativeToDart_Dictionary(this._item_1$1(index));
},
 _item_1$1: function(index) {
  return this.item(index);
}
});
...
$.$defineNativeClass('SVGRect', ["width!"], {
});
...
$.$defineNativeClass('HTMLTableCellElement', ["width!"], {
 is$Element: function() { return true; }
});
...
$.$defineNativeClass('HTMLVideoElement', ["width!"], {
 is$Element: function() { return true; }
});
...
$.$defineNativeClass('DOMWindow', ["console?", "length?", "name?", "navigator?", "webkitStorageInfo?"], {
 get$document: function() {
...
//@ sourceMappingURL=explorer_dart.dart.js.map