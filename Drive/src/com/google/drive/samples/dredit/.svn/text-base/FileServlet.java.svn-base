...
public class FileServlet extends DrEditServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			file = files.get(fileId).execute();
			
			if ( file != null ){
				resp.getWriter().print("Extencion === "+file.getFileExtension());
			}else{
				resp.getWriter().print("No encontramos el Archivo");
			}
			...
			resp.getWriter().print("Error:  "+e.getStatusCode());
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		resp.getWriter().print(req.getParameter("file_id"));
